package com.w.h.netty.protoBuf;// Generated by the protocol buffer compiler.  DO NOT EDIT!
...
public final class studentPOJO {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     * 表明 student类中有一个属性 名字为id  类型为int32（是protobuf类型） 1 表示属性序号 不是值 。
     * </pre>
     *
  ...
  /**
   * <pre>
   * 会在 studentPOJO外部类生成一个内部类  内部类的名称  就是 Student 他是真正发送的pojo对象
   * </pre>
   *
